...
export default function StudioCulture() {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#E0EAFF] via-white to-[#FFE4F3] text-charcoal">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {culture.map((item, index) => (
            <AnimatedReveal
              ...
              direction="up"
              delay={index * 0.1}
              className="bg-white/90 backdrop-blur rounded-3xl p-5 sm:p-6 shadow-xl border border-white/70"
            >
