...
export default function InsightsHero() {
  return (
    <section className="pt-20 sm:pt-24 md:pt-32 pb-12 sm:pb-16 md:pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#FFF2CC] via-[#DFF2FF] to-[#FFE0F0] relative overflow-hidden">
